        ...
        >
          ...
          {createConfirmed && createTxHash && (
            ...
            >
              ...
              <a
                ...
                style={{ color: "#00ff88", textDecoration: "underline", opacity: 0.8 }}
              >
                View tx
              </a>
            </div>
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              cursor:
                !agentId || !maxTradeSize || createWritePending || createConfirming
                  ? "not-allowed"
                  : "pointer",
              fontFamily: "inherit",
            }}
      ...
      {!isLoading && mandates.length > 0 && (
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          {mandates.map((mandate) => {
            const isRevoking =
              revokingId === mandate.id && (revokeWritePending || revokeConfirming);
            return (
              <div
                key={mandate.id}
                style={{
